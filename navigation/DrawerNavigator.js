...
import VideoWithCodeAdminScreen from '../screens/VideoWithCode/VideoWithCodeAdmin';
...
export default function DrawerNavigator() {
  ...
  return (
    ...
    <Drawer.Navigator 
      initialRouteName="VideoWithCode"
      ...
      screenOptions={ ({route}) => ({
        ...
        drawerIcon: ({ focused, color, size }) => {
          ...
          }else if (route.name === 'VideoWithCode') {
    ...
    >
      ...
      <Drawer.Screen 
        name="VideoWithCode"       
        component={VideoWithCodeAdminScreen}    
        options={{
          title:'Video With Code',
          headerShown:true,
        }}   
      />
